...
public class PlayerActivityFragment2 extends Fragment implements MediaEvents{
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.music_player_layout,container,false);
        return v;
    }

    public static PlayerActivityFragment2 getNewInstance()
    {
        return new PlayerActivityFragment2();
    }
...
//Make sure you update Seekbar on UI thread
     ...
     //   viewPager.setPageTransformer(true, new ZoomOutPageTransformer());
        ...
        equalizer.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                NavigationControler.navigateToEqualiser(getFragmentManager());
            }
        });
        showPlaylist.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                NavigationControler.navigateToNowPlayingList(getFragmentManager());
...
*/
    ...
    private ServiceConnection serviceConnection = new ServiceConnection() {
        ...
        public void onServiceConnected(ComponentName name, IBinder service) {
            ...
            updateViewPager();
            mBound =true;
            music.setCallbacks(PlayerActivityFragment2.this);
            try {
                setBlurBackdround();
            }
            catch (Exception e)
